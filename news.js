...
Each object must have exactly: title, source, summary (2 sentences), sentiment (positive/negative/neutral), symbol (SCOM/EQTY/KCB/EABL/BRIT/NSE), date (e.g. Mar 11, 2026).`;
  ...
  // Hardcoded fallback — always shows news even if AI is down
  return {
    statusCode: 200,
    headers,
    body: JSON.stringify({
      news: [
        ...
        { title: "EABL faces margin pressure as excise duty rises", source: "The Star Kenya", summary: "East African Breweries warned of near-term margin pressure following the government's decision to raise excise duty on alcoholic beverages by 15%. The company is reviewing its pricing strategy ahead of Q2.", sentiment: "negative", symbol: "EABL", date: "Mar 7, 2026" },
